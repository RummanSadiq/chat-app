...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function addMessage(data) {
      ...
      this.conversationTarget.innerHTML += message_template(context); // var all_messages = document.getElementsByTagName("select");
      // var lastSelect = allSelects[allSelects.length-1];
      // message_div.style.background = data.color_code;
    }
  }, {
...
/******/ });
//# sourceMappingURL=chat_controller-7d98919a8ab9f14c01b7.js.map