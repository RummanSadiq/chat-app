  ...
  _createClass(_default, [{
    ...
    value: function sendMessage() {
      if (this.inputTarget.value) {
        var message = handlebars__WEBPACK_IMPORTED_MODULE_1__["Handlebars"].compile(this.templateTarget.innerHTML);
        var context = {
          message: this.inputTarget.value,
          time: this.getCurrentTime()
        };
        console.log("Clicked", this.inputTarget.value);
        this.conversationTarget.append = message(context);
...
/******/ });
//# sourceMappingURL=chat_controller-b5a6e8cd10636f90d5d5.js.map