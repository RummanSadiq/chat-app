...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function addMessage(data) {
      var message_template = getMessageTemplate(data.user_name);
      var context = {
        name: data.user_name,
        message: data.message,
        time: this.getCurrentTime()
      };
      message_div = message_template(context);
      this.conversationTarget.innerHTML += message_div;
      message_div.css("background-color", data.color_code);
    }
  }, {
...
/******/ });
//# sourceMappingURL=chat_controller-6a936cce2fa4c8bd2528.js.map