...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'handlebars'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
function (_Controller) {
  ...
  _createClass(_default, [{
    key: "connect",
    value: function connect() {// console.log("Hello, Stimulus!", this.element)
    }
  }, {
    key: "sendMessage",
    value: function sendMessage() {
      if (this.inputTarget.value) {
        debugger;
        var message = Handlebars.compile(message - templateTarget.html());
        var context = {
          message: this.inputTarget.value,
          time: this.getCurrentTime()
        };
        console.log("Clicked", this.inputTarget.value);
        this.conversationTarget.append = "\n      <li class=\"clearfix\">\n        <div class=\"message-data align-right\">\n          <span class=\"message-data-time\" >10:10 AM, Today</span> &nbsp; &nbsp;\n          <span class=\"message-data-name\" >Olia</span> <i class=\"fa fa-circle me\"></i>\n\n        </div>\n        <div class=\"message my-message float-right\">\n          ".concat(this.inputTarget.value, "\n        </div>\n      </li>");
...
_default.targets = ["input", "conversation", "message-template"];
...
/******/ });
//# sourceMappingURL=application-8319ae0517f5d3a40f82.js.map